...
\begin{frame}
	...
	\begin{itemize}
		\item Q-Learning methods learn an approximator $Q_{\theta}(s,a)$ for the optimal action-value function, $Q^*(s,a)$.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Episoded of self-play performed in parallel to drastically reduce the training time (taking inspiration form the work of David Silver "Playing Atari with Deep Reinforcement Learning" \cite{mnih2013atari}).
